    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, help_text='Detalles internos sobre materiales o proveedores.', verbose_name='Descripción Técnica')),
                ...
                ('precio_base', models.DecimalField(decimal_places=2, default=0.0, max_digits=12, verbose_name='Precio Venta Base')),
                ('costo_estandar', models.DecimalField(decimal_places=2, default=0.0, help_text='Costo referencial para cálculo de márgenes.', max_digits=12, verbose_name='Costo Estándar')),
                ('requiere_medidas', models.BooleanField(default=False, help_text='Si es True, el sistema obligará a ingresar Ancho y Alto en la cotización.', verbose_name='¿Requiere Medidas?')),
            ...
            options={
                ...
                'ordering': ['nombre'],
                'indexes': [models.Index(fields=['tipo_producto'], name='productos_s_tipo_pr_d551d8_idx'), models.Index(fields=['codigo'], name='productos_s_codigo_ab3c89_idx')],
            },
        ),
    ]
