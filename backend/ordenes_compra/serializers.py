...
class DetalleOrdenCompraSerializer(serializers.ModelSerializer):
    ...
    producto_id = serializers.PrimaryKeyRelatedField(
        queryset=ProductoServicio.objects.all(), source='producto', write_only=True
    )
...
class OrdenCompraSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['numero_orden', 'total',
    ...
    def create(self, validated_data):
        ...
        for detalle_data in detalles_data:
            detalle = DetalleOrdenCompra.objects.create(
                orden_compra=orden_compra, **detalle_data)
    ...
    def update(self, instance, validated_data):
        ...
        instance.fecha_entrega_prevista = validated_data.get(
            'fecha_entrega_prevista', instance.fecha_entrega_prevista)
        instance.save()
        return instance
